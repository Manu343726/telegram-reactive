...
SOURCEDIR = '/home/manu343726/Documentos/telegram-reactive'
SRC_DIR = os.path.join(SOURCEDIR, 'src')
INCLUDE_DIR = os.path.join(SOURCEDIR, 'include', 'ReactiveTelegram')
BINARY_DIR = '/home/manu343726/Documentos/telegram-reactive/build'
...
compilation_database_folder = '/home/manu343726/Documentos/telegram-reactive/build'
...
def GetCompilationInfoForFile( filename ):
  ...
  if IsHeaderFile( filename ):
    for extension in SOURCE_EXTENSIONS:
      replacement_file = ReplacementFile(filename, extension)
